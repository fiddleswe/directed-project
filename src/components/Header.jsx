...
// Tailwind Classes Group
const iconClass =
  "absolute left-3 top-1/2 -translate-y-1/2 text-[22px] text-white text-opacity-60";

const navClass =
  "left-0 top-0 z-50 w-full border-b-[1.5px] border-white/15 bg-black p-4 shadow-md";

const ulClass =
  "flex items-center justify-start gap-5 text-[14px] font-medium text-white text-opacity-60 ml-5";

const inputClass =
  "placeholder-white/60 text-white bg-[#2C2C2C] w-96 h-12 rounded-xl pl-11";
